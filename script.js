/*
 * script.js - All interactive behavior for the Student Portfolio
 ...
 * - Includes <script> tag that loads this script.js file
 * - Has id="themeToggle" button that this script.js interacts with
